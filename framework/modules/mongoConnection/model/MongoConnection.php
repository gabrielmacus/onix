...
namespace framework\modules\mongoConnection\model;
...
class MongoConnection
{
     ...
     * @param $port
     */
    public function __construct($db,$user="", $password="",$host="127.0.0.1", $port=27017 )
    {
        $this->user = $user;
    ...
    public function connect()
    {
        if(empty($this->client) || empty($this->client->connected))
        {
            ...
            $this->client=new \MongoClient($uri,["connect"=>false]);
